/*
07.	Accounts
The waiters need to have access to the new software, so they need personal accounts.
Your task is to generate their usernames and passwords.
Write a query that returns: the username and password for all waiters
who are not fired (a fired waiter is a waiter without salary).
The username is generated by their last name
immediately followed by their first name
