...
From the database extract the full_name and age_group of the athletes.
  If the athlete is 18 years of age or younger user must see "Teenager",
  if it is between 18 (exclusive) and 25 years (inclusive) of age it should display "Young adult".
