...
INSERT INTO car_rental.categories(category, daily_rate, weekly_rate, monthly_rate, weekend_rate)
VALUES  ('Category 1', 1, 2, 3, 4),
        ('Category 2', 2, 3, 4, 5),
        ('Category 3', 3, 4, 5, 6);

INSERT INTO car_rental.cars(plate_number, make, model, car_year, category_id, doors, picture, car_condition, available)
VALUES  ('Plate 1', 'Make 1', 'Model 1', '2005', 1, 4, 'Text', 'Good', TRUE),
        ('Plate 2', 'Make 2', 'Model 2', '2005', 2, 4, 'Text', 'Good', TRUE),
        ('Plate 3', 'Make 3', 'Model 3', '2005', 3, 4, 'Text', 'Good', TRUE);

INSERT INTO car_rental.customers(driver_licence_number, full_name, address, city, zip_code, notes)
VALUES  (1, 'Name 1', 'Address 1', 'City1', 1, 'text'),
        (2, 'Name 2', 'Address 2', 'City2', 2, 'text'),
        (3, 'Name 3', 'Address 3', 'City3', 3, 'text');

INSERT INTO car_rental.employees(first_name, last_name, title, notes)
VALUES  ('First Name 1', 'Last Name 1', 'Title 1', 'Text'),
        ('First Name 2', 'Last Name 2', 'Title 2', 'Text'),
        ('First Name 3', 'Last Name 3', 'Title 3', 'Text');

INSERT INTO car_rental.rental_orders(employee_id, customer_id, car_id, car_condition, tank_level, kilometrage_start, kilometrage_end, total_kilometrage, start_date, end_date, total_days, rate_applied, tax_rate, order_status, notes)
VALUES  (1, 1, 1, 'Good', 100, 1111, 1121, 10, '2022-01-01', '2022-01-02', 2, 1.1, 1.1, TRUE, 'Text'),
