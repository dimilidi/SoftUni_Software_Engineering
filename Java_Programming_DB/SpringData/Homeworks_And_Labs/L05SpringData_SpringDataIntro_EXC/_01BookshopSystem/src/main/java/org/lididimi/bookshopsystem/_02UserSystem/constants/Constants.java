package org.lididimi.bookshopsystem._02UserSystem.constants;
...
public class Constants {
    ...
    public static final String PASSWORD_TOO_SHORT = "Password too short! Must be between 6 and 30 symbols!";
